    ...
    @if (Route::has('login'))
        @auth
            <div class="zurf-page-title-wrap zurf-style-custom zurf-center-align"
                style="background-image: url(images/ourtte.jpg)">
                            ...
                            <div class="tourmaster-sidebar-center tourmaster-column-60">
                                <div class="tourmaster-page-content">
                                    <div class="InputContainer">
                                        <input placeholder="Search" id="input" class="input" name="text"
                                            type="text" />
                                        ...
                                        <div
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step="0.01"
                                                                class="form-control input-field" name="price" id="price"
                                                                required>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tourmaster-tour-item-holder gdlr-core-js-2 clearfix"
                                                ...
                                                @foreach ($ourtripcruds as $ourtripcrud)
                                                                ...
                                                                <div class="tourmaster-tour-content-wrap gdlr-core-skin-e-background gdlr-core-js"
                                                                    ...
                                                                    <div class="tourmaster-tour-booking"
                                                                        ...
                                                                        <button class="tourmaster-button"
                                                                            onclick="document.getElementById('bookingModal{{ $ourtripcrud->id }}').style.display='block'"
                                                    ...
                                                    <div id="bookingModal{{ $ourtripcrud->id }}" class="modal" style="display:none;">
                                                        <div class="modal-content">
                                                            <span class="close" onclick="document.getElementById('bookingModal{{ $ourtripcrud->id }}').style.display='none'">&times;</span>
